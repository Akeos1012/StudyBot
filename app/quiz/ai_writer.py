...
class AIWriter:
    ...
    def __init__(self, model: str = "deepseek-r1:1.5b", temperature: float = 0.3,
                 top_p: float = 0.8, num_predict: int = 800):
        """
    ...
    def generate_from_fact(self, fact: str, answer: str, topic: str,
                           num_predict: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    def generate_from_context(self, context: str, topic: str,
                              num_predict: Optional[int] = None) -> List[Dict[str, Any]]:
        """
...
def generate_questions(fact: str, answer: str, topic: str,
                       model: str = "deepseek-r1:1.5b",
                       temperature: float = 0.3,
                       top_p: float = 0.8,
                       num_predict: int = 800) -> Optional[Dict[str, Any]]:
    """
