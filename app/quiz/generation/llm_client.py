...
LLM_DEFAULT_TIMEOUT = getattr(settings, "LLM_DEFAULT_TIMEOUT", 30)
...
class LLMClient:
    ...
    def __init__(
        ...
        timeout: Optional[int] = LLM_DEFAULT_TIMEOUT,
    ):
        """
    ...
    def chat(
        ...
        **kwargs,
        ...
        options = self._build_options(temperature, top_p, num_predict, **kwargs)
