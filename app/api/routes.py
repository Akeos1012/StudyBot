...
This module contains the HTTP endpoint handlers for the API.
...
def setup_routes(metadata_loader, metadata):
    """Configure routes with dependencies."""
    quiz_service = QuizService(metadata_loader)
    ...
    async def refresh_notes():
        ...
        # Update the outer metadata reference
        return {
